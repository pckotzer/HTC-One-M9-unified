...
BOARD_KERNEL_CMDLINE := androidboot.hardware=qcom user_debug=31 ehci-hcd.park=3 androidusb.pid=0x065d androidkey.dummy=1 androidtouch.htc_event=1 disk_mode_enable=1 boot_cpus=0,1,2 sched_enable_hmp=1 sched_enable_power_aware=1 androidboot.rpmdevice=fc190000.qcom,rpm-stats-ver buildvariant=userdebug
